...
export class CreateSalesProposalDto {
  @IsOptional() @IsString() proposalNumber?: string;

  @IsOptional() @Transform(emptyToUndefined) @IsUUID() quoteId?: string;
  ...
  @IsOptional() @Transform(emptyToUndefined) @IsDateString() validUntil?: string;
