    ...
    <div className="min-h-screen bg-white text-slate-900">
      ...
      <section className="w-full bg-gradient-to-br from-white via-blue-50/30 to-blue-100/40 pt-28 pb-20">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center gap-12">
          ...
          {/* Right column kept for layout balance — hero image removed */}
          <div className="flex-1">
            <div className="rounded-2xl shadow-xl border border-slate-100 p-10">
              {/* Placeholder content so layout remains pleasant until real image is added */}
              <div className="h-64 flex items-center justify-center text-slate-400">
                Illustration / hero removed for build — will be restored later
              </div>
            </div>
          </div>
        </div>
