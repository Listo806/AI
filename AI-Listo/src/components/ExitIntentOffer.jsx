...
// New exit-intent popup: a registration form. On submit it creates the Cortexa
// account immediately (source = exit_popup, no plan yet) and sends the visitor to
// the pricing page to choose a plan on the next step — so their details are saved
// as a lead before any payment, and never re-entered. Replaces the old $7
// activation popup; the $7 override is no longer set here.
const T = {
  en: {
    headline1: "WAIT!",
...
export default function ExitIntentOffer() {
  ...
  // Escape to close, focus the card, and lock the page scroll while open.
  useEffect(() => {
