...
export const SOCIAL_IMAGE = `${SITE_ORIGIN}/images/cortexa-social-preview.jpg`;
...
// in a language when an approved translation is published for it.
export const INDEXABLE_PAGES = [
  ...
  { path: "/integrations", file: "src/pages/common/IntegrationsPage.jsx", languages: ["en", "es", "pt"], priority: "0.7", changefreq: "monthly" },
  ...
  { path: "/help", file: "src/pages/common/HelpCenter.jsx", languages: ["en", "es", "pt"], priority: "0.5", changefreq: "monthly" },
  { path: "/support", file: "src/pages/common/Support.jsx", languages: ["en", "es", "pt"], priority: "0.5", changefreq: "monthly" },
  ...
  { path: "/web-solutions", file: "src/pages/web-solutions/WebSolutions.jsx", languages: ["en"], priority: "0.7", changefreq: "monthly" },
...
export const NOINDEX_PUBLIC_PAGES = [
  ...
  "/onboarding", "/card", "/web-solutions/checkout",
];

// Everything behind a login, plus the one-time links. Rewritten to the app and
// marked noindex; never prerendered and never in the sitemap.
export const PRIVATE_PREFIXES = [
  "/dashboard", "/e-commerce", "/account", "/settings", "/admin",
...
export function pageFor(basePath) {
  const key = basePath && basePath !== "/" ? basePath.replace(/\/+$/, "") : "/";
...
export function isNoIndexPath(pathname) {
  ...
  if (NOINDEX_PUBLIC_PAGES.includes(base)) return true;
  if (PRIVATE_PREFIXES.some((p) => base === p || base.startsWith(`${p}/`))) return true;
