...
const t = {
  en: {
    nav: { features: "Features", aiAssistant: "AI Assistant", automations: "Automations", integrations: "Integrations", analytics: "Analytics", login: "Log In", trial: "Get Started" },
    hero: { badge: "Product Overview", title: "CORTEXA Features", line1: "Everything growing businesses need to ", line2: "capture, manage, and close", line3: " more deals.", desc: "CORTEXA brings leads, WhatsApp conversations, AI follow-up, pipeline intelligence, automations, analytics, and team workflows into one Agentic CRM with specialized workspaces for every kind of business.", btnTrial: "Get Started", btnIntegrations: "View Integrations" },
    coreSection: { title: "Complete Pipeline Control for Every Business", desc: "Every tool your team needs to convert raw traffic into closed revenue." },
    coreFeatures: [
      { title: "AI Lead Capture", text: "Automatically pull leads from Meta, Google, forms, and marketplaces instantly into your pipeline." },
      ...
      { title: "Pipeline Intelligence", text: "Track deal visual cards, contact velocity, transaction records, and client interaction logs." },
      { title: "Smart CRM Automation", text: "Eliminate administrative bottlenecks. Route leads, assign team members, and trigger updates." },
      { title: "Team Workspace", text: "Manage multiple team members, permissions, shared calendars, and performance reports smoothly." },
      { title: "Analytics & Forecasting", text: "Deep analytical dashboard covering revenue, team activity, and source conversions." }
    ],
    aiSection: { marker: "AI Engine", title: "24/7 AI Assistant Inside Your CRM", desc: "The AI Assistant helps your team respond faster, qualify leads, suggest next actions, summarize conversations, and support follow-up.", bullets: ["Helps qualify leads based on intent, budget, and timeline.", "Suggests next-best actions to guide prospects closer to a decision.", "Supports natural WhatsApp-style conversational responses.", "Helps your team avoid missed opportunities during off-hours.", "Works as a non-stop assistant integrated directly into your workflow."], chatTitle: "CORTEXA AI Agent", chatStatus: "Online", msgLeft: "Is this property still available for viewing this Saturday?", msgRight: "Yes! I can lock in 2:00 PM for you, or would you prefer a morning slots?", suggested: "Suggested Next Action: Send calendar link" },
    autoSection: { marker: "Operations", title: "Smart Workflows, Zero Redundant Work", desc: "CORTEXA automates repetitive work so your team can focus on closing deals.", bullets: ["Automated lead routing based on zip codes, value, or round-robin rules.", "Automated follow-up reminders so hot opportunities never turn cold.", "Instant pipeline stage updates when a client takes an action.", "Team assignment workflows to balance workloads effortlessly.", "Multi-channel WhatsApp/email-style follow-up flows."], node1: "New Lead Arrived ➔ Meta Ads", node2: "AI Assigned & Route ➔ Team Member", node3: "Instant WhatsApp Campaign Dispatched" },
    analyticsSection: { marker: "Intelligence", title: "Data-Driven Pipeline Analytics", desc: "CORTEXA gives your team visibility into leads, deals, pipeline, activity, and revenue forecasting.", bullets: ["Detailed lead performance tracking across all digital sources.", "Real-time pipeline value visibility to monitor potential revenue.", "Conversion tracking pinpointing leaky steps in sales funnels.", "Predictive revenue forecasting metrics using performance history.", "Team performance and actionable activity insights."], pipeValue: "Pipeline Value", convRate: "Conversion Rate: +4.2%" },
    ctaSection: { title: "Ready to organize your business with CORTEXA?", btnTrial: "Get Started", btnSupport: "Contact Support" },
  ...
  es: {
    nav: { features: "Características", aiAssistant: "Asistente IA", automations: "Automatizaciones", integrations: "Integraciones", analytics: "Análisis", login: "Iniciar Sesión", trial: "Comenzar" },
    hero: { badge: "Descripción del Producto", title: "Características de CORTEXA", line1: "Todo lo que los negocios en crecimiento necesitan para ", line2: "captar, gestionar y cerrar", line3: " más tratos.", desc: "CORTEXA reúne clientes potenciales, conversaciones de WhatsApp, seguimiento de IA, inteligencia de pipeline, automatizaciones, análisis y flujos de trabajo de equipo en un CRM agéntico con espacios de trabajo especializados para cada tipo de negocio.", btnTrial: "Comenzar", btnIntegrations: "Ver Integraciones" },
    coreSection: { title: "Control Completo del Pipeline para Cada Negocio", desc: "Cada herramienta que su equipo necesita para convertir el tráfico bruto en ingresos cerrados." },
    coreFeatures: [
      { title: "Captura de Leads con IA", text: "Extraiga automáticamente clientes potenciales de Meta, Google, formularios y marketplaces al instante en su pipeline." },
      ...
      { title: "Inteligencia de Pipeline", text: "Realice un seguimiento de tarjetas visuales de ofertas, velocidad de contacto, registros de transacciones e historial de interacciones con clientes." },
      ...
      { title: "Espacio de Trabajo del Equipo", text: "Gestione múltiples miembros del equipo, permisos, calendarios compartidos e informes de rendimiento de manera fluida." },
      { title: "Análisis y Previsión", text: "Panel analítico profundo que cubre ingresos, actividad del equipo y conversiones de origen." }
    ],
    aiSection: { marker: "Motor de IA", title: "Asistente de IA 24/7 Dentro de su CRM", desc: "El Asistente de IA ayuda a su equipo a responder más rápido, calificar clientes potenciales, sugerir próximas acciones, resumir conversaciones y apoyar el seguimiento.", bullets: ["Ayuda a calificar leads según intención, presupuesto y cronograma.", "Sugiere las mejores acciones a seguir para acercar a los prospectos a una decisión.", "Admite respuestas conversacionales naturales al estilo de WhatsApp.", "Ayuda a su equipo a evitar oportunidades perdidas fuera del horario laboral.", "Funciona como un asistente continuo integrado directamente en su flujo de trabajo."], chatTitle: "Agente IA de CORTEXA", chatStatus: "En línea", msgLeft: "¿Esta propiedad sigue disponible para verla este sábado?", msgRight: "¡Sí! Puedo reservar las 2:00 PM para usted, ¿o prefiere un horario por la mañana?", suggested: "Próxima acción sugerida: Enviar enlace de calendario" },
    autoSection: { marker: "Operaciones", title: "Flujos de Trabajo Inteligentes, Cero Trabajo Redundante", desc: "CORTEXA automatiza el trabajo repetitivo para que su equipo pueda concentrarse en cerrar tratos.", bullets: ["Enrutamiento automatizado de leads según códigos postales, valor o reglas de distribución equitativa.", "Recordatorios de seguimiento automatizados para que las oportunidades calientes nunca se enfríen.", "Actualizaciones instantáneas de la etapa del pipeline cuando un cliente realiza una acción.", "Flujos de trabajo de asignación de equipos para equilibrar las cargas de trabajo sin esfuerzo.", "Flujos de seguimiento multicanal estilo WhatsApp/correo electrónico."], node1: "Nuevo Lead Recibido ➔ Meta Ads", node2: "IA Asignada y Enrutada ➔ Miembro del Equipo", node3: "Campaña Instantánea de WhatsApp Enviada" },
    analyticsSection: { marker: "Inteligencia", title: "Análisis de Pipeline Impulsado por Datos", desc: "CORTEXA brinda a su equipo visibilidad sobre leads, ofertas, pipeline, actividad y pronósticos de ingresos.", bullets: ["Seguimiento detallado del rendimiento de leads en todas las fuentes digitales.", "Visibilidad del valor del pipeline en tiempo real para monitorear posibles ingresos.", "Seguimiento de conversión identificando pasos con fugas en los embudos de ventas.", "Métricas predictivas de previsión de ingresos utilizando el historial de rendimiento.", "Rendimiento del equipo e información de actividad procesable."], pipeValue: "Valor del Pipeline", convRate: "Tasa de conversión: +4.2%" },
    ctaSection: { title: "¿Listo para organizar su negocio con CORTEXA?", btnTrial: "Comenzar", btnSupport: "Soporte de Contacto" },
  ...
  pt: {
    nav: { features: "Recursos", aiAssistant: "Assistente IA", automations: "Automações", integrations: "Integrações", analytics: "Análise", login: "Entrar", trial: "Começar" },
    hero: { badge: "Visão Geral do Produto", title: "Recursos da CORTEXA", line1: "Tudo o que os negócios em crescimento precisam para ", line2: "capturar, gerenciar e fechar", line3: " mais negócios.", desc: "A CORTEXA traz leads, conversas de WhatsApp, acompanhamento de IA, inteligência de pipeline, automações, análises e fluxos de trabalho de equipe em um CRM agêntico com espaços de trabalho especializados para cada tipo de negócio.", btnTrial: "Começar", btnIntegrations: "Ver Integrações" },
    coreSection: { title: "Controle Total do Pipeline para Cada Negócio", desc: "Todas as ferramentas que sua equipe precisa para converter tráfego bruto em receita fechada." },
    coreFeatures: [
      { title: "Captura de Leads com IA", text: "Puxe leads automaticamente do Meta, Google, formulários e marketplaces instantaneamente para seu pipeline." },
      ...
      { title: "Inteligência de Pipeline", text: "Monitore cartões visuais de negócios, velocidade de contato, registros de transações e histórico de interações com clientes." },
      ...
      { title: "Espaço de Trabalho em Equipe", text: "Gerencie múltiplos membros da equipe, permissões, calendários compartilhados e relatórios de desempenho perfeitamente." },
      { title: "Análise e Previsão", text: "Painel analítico profundo que cobre receita, atividade da equipe e conversões de origem." }
    ],
    aiSection: { marker: "Motor de IA", title: "Assistente de IA 24/7 Dentro do seu CRM", desc: "O Assistente de IA ajuda sua equipe a responder mais rápido, qualificar leads, sugerir próximas ações, resumir conversas e apoiar o acompanhamento.", bullets: ["Ajuda a qualificar leads com base na intenção, orçamento e prazo.", "Sugere as próximas melhores ações para guiar os prospects rumo a uma decisão.", "Suporta respostas conversacionais naturais no estilo WhatsApp.", "Ajuda sua equipe a evitar oportunidades perdidas fora do horário comercial.", "Funciona como um assistente ininterrupto integrado diretamente ao seu fluxo de trabalho."], chatTitle: "Agente de IA CORTEXA", chatStatus: "Online", msgLeft: "Este imóvel ainda está disponível para visitação neste sábado?", msgRight: "Sim! Posso agendar para as 14h para você, ou prefere um horário pela manhã?", suggested: "Próxima ação sugerida: Enviar link do calendário" },
    autoSection: { marker: "Operações", title: "Fluxos de Trabalho Inteligentes, Zero Trabalho Redundante", desc: "A CORTEXA automatiza o trabalho repetitivo para que sua equipe possa focar no fechamento de negócios.", bullets: ["Roteamento automatizado de leads com base em CEPs, valor ou regras de rodízio.", "Lembretes automatizados de acompanhamento para que as oportunidades quentes nunca esfriem.", "Atualizações instantâneas de estágio do pipeline quando um cliente realiza uma ação.", "Fluxos de trabalho de atribuição de equipe para equilibrar as cargas de trabalho sem esforço.", "Fluxos de acompanhamento multicanais estilo WhatsApp/e-mail."], node1: "Novo Lead Recebido ➔ Meta Ads", node2: "IA Atribuída e Roteada ➔ Membro da Equipe", node3: "Campanha Instantânea de WhatsApp Disparada" },
    analyticsSection: { marker: "Inteligência", title: "Análise de Pipeline Baseada em Dados", desc: "A CORTEXA oferece à sua equipe visibilidade de leads, negócios, pipeline, atividade e previsão de receita.", bullets: ["Rastreamento detalhado do desempenho de leads em todas as fontes digitais.", "Visibilidade do valor do pipeline em tempo real para monitorar possível receita.", "Rastreamento de conversão identificando etapas com gargalos nos funis de vendas.", "Métricas preditivas de previsão de receita usando o histórico de desempenho.", "Desempenho da equipe e insights de atividades acionáveis."], pipeValue: "Valor do Pipeline", convRate: "Taxa de Conversão: +4.2%" },
    ctaSection: { title: "Pronto para organizar seu negócio com a CORTEXA?", btnTrial: "Começar", btnSupport: "Suporte de Contato" },
      ...
      {isMobile ? (
        <header className={styles.mHeader}>
          <div className={styles.mLogoBlock}>
            <a href="/"><img src={headlogoM} alt="Cortexa Agentic CRM" className="cx-logo-img" /></a>
          </div>
