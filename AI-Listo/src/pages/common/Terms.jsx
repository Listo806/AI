  ...
  en: {
    ...
    sections: [
      ...
      },
      {
        ...
        groups: [
          { heading: "Free Trial", text: "CORTEXA AI Revenue OS includes a 14-day free trial that begins right after you complete signup. Your monthly plan is not billed during the 14-day trial. The trial starts once your one-time setup fee is paid." },
          { heading: "Setup Fee", text: "A one-time setup and activation fee of $97 USD is charged today at signup, before your free trial begins, and requires a payment method (PayPal). The setup fee covers onboarding, account provisioning, platform configuration, and activation services. It is separate from your monthly plan." },
          ...
          { heading: "How Billing Works", text: "You pay the one-time $97 USD setup fee at signup through PayPal. Your 14-day free trial then begins with no plan charge. When the trial ends, your selected monthly plan is billed automatically each month and continues until you cancel. You may cancel at any time to stop future charges." },
        ],
      },
      {
  ...
  es: {
    ...
    sections: [
      ...
      { title: "Prueba Gratuita, Configuración y Facturación", groups: [
        { heading: "Prueba Gratuita", text: "CORTEXA incluye una prueba gratuita de 14 días que comienza justo después de completar tu registro. Tu plan mensual no se cobra durante los 14 días de prueba. La prueba comienza una vez que se paga la tarifa única de configuración." },
        { heading: "Tarifa de Configuración", text: "Se cobra hoy una tarifa única de configuración y activación de $97 USD al registrarte, antes de que comience tu prueba gratuita, y requiere un método de pago (PayPal). Cubre incorporación, aprovisionamiento, configuración y activación. Es independiente de tu plan mensual." },
        ...
        { heading: "Cómo Funciona la Facturación", text: "Pagas hoy la tarifa única de configuración de $97 USD mediante PayPal. Luego comienza tu prueba gratuita de 14 días sin cargo del plan. Al terminar la prueba, tu plan mensual seleccionado se cobra automáticamente cada mes y continúa hasta que canceles. Puedes cancelar en cualquier momento para evitar cobros futuros." },
      ] },
  ...
  pt: {
    ...
    sections: [
      ...
      { title: "Teste Gratuito, Configuração e Cobrança", groups: [
        { heading: "Teste Gratuito", text: "O CORTEXA inclui um teste gratuito de 14 dias que começa logo após você concluir o cadastro. Seu plano mensal não é cobrado durante os 14 dias de teste. O teste começa assim que a taxa única de configuração é paga." },
        { heading: "Taxa de Configuração", text: "Uma taxa única de configuração e ativação de $97 USD é cobrada hoje no cadastro, antes do início do seu teste gratuito, e exige um método de pagamento (PayPal). Ela cobre onboarding, provisionamento, configuração e ativação. É separada do seu plano mensal." },
        ...
        { heading: "Como Funciona a Cobrança", text: "Você paga hoje a taxa única de configuração de $97 USD via PayPal. Em seguida, começa seu teste gratuito de 14 dias sem cobrança do plano. Quando o teste termina, o plano mensal escolhido é cobrado automaticamente a cada mês e continua até você cancelar. Você pode cancelar a qualquer momento para evitar cobranças futuras." },
      ] },
