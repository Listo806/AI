...
const COPY = {
  ...
  es: {
    ...
    processing: "Activando tu plan Business…",
    signInTitle: "Inicia sesión para obtener esta oferta",
    signInBody: "Inicia sesión en tu cuenta de Cortexa y vuelve a abrir este enlace para completar tu mejora a Business por $257.",
