...
export const PLANS = {
  free: {
    ...
    limits: { aiConversationsPerMonth: 50, automationWorkflows: 5, integrations: 1 },
    features: {
      crm: true, aiAgent: true, automations: true, emailSmsMarketing: false,
      calendar: false, reports: false, advancedAnalytics: false, teamWorkspace: false,
  ...
  solo: {
    ...
    limits: { aiConversationsPerMonth: null, automationWorkflows: null, integrations: null },
    features: {
